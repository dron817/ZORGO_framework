...
<head>
    ...
    <!-- Мой добавочный CSS -->
    <link rel="stylesheet" href="assets/css/radial-progress.css">
...
<body>
<!-- Header Start -->
<div id="header-spacer" style="height: 60px;"></div>
<header id="header">
    <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar nav-bg">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="img/logo.gif" alt=""></a>
            </div>
            <div class="collapse navbar-collapse" id="main-navbar">
                <ul class="navbar-nav mr-auto w-100 justify-content-end">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="?route=lk" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false">
                            Профиль
                        </a>
                    </li>
        ...
        <ul class="wpb-mobile-menu">
            ...
            <li>
                <a href="index.php?route=lk">Профиль</a>
            </li>
            <li>
    ...
    <div class="container pt-5 mb-5">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 col-xl-3 footer-contact-widget">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates eos minus expedita ipsum soluta
                    voluptatem sed architecto.</p>
                <ul>
                    <li>
