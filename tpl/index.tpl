    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-md-8 col-lg-8 col-xs-12 text-left wow animated fadeInLeft" data-wow-delay=".2s">
                <h1> </h1><br>
                <h1>LaySise</h1>
                <h3>Сервис геймификации полезных привычек</h3>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 col-xl-3 wow animated fadeInUp" data-wow-delay=".2s">
                <div class="about-single">
                    <i class="material-icons mdi mdi-account-star"></i>
                    <h2 class="subtitle">Индивидуально</h2>
                    <p>Выбери свои предпочтения и получи персональный план</p>
                </div>
            </div>
            <!-- Single About -->
            <div class="col-md-6 col-lg-3 col-xl-3 wow animated fadeInUp" data-wow-delay=".3s">
                <div class="about-single">
                    <i class="material-icons mdi mdi-gamepad-variant"></i>
                    <h2 class="subtitle">Весело</h2>
                    <p>Преврати свою ежедневную рутину в игру</p>
                </div>
            </div>
            <!-- Single About -->
            <div class="col-md-6 col-lg-3 col-xl-3 wow animated fadeInUp" data-wow-delay=".4s">
                <div class="about-single">
                    ...
                    <p>Мы не тратим ваше время, мы лишь помогаем его организовать</p>
                </div>
            </div>
            <!-- Single About -->
            <div class="col-md-6 col-lg-3 col-xl-3 wow animated fadeInUp" data-wow-delay=".5s">
                <div class="about-single">
                    ...
                    <h2 class="subtitle">Доступно</h2>
                    <p>Заходи и отмечай свой прогресс с любого устройства</p>
                </div>
            </div>
        </div>
    </div>
